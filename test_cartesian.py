...
testset = data.UR10Dataset("data", modality=["endpoint", "joint"], action=["grasp", "move"], mode="test")
...
for exp in range(N):
    ...
    with torch.no_grad():
        ...
        # forecasting
        z_pos, z_joint = model.forecast(x_condition, forward_t, backward_t, banned_modality=banned_mods)
